...
const Portfolio = () => {
    ...
    const portfolioTabControls = [
        { id: 1, title: 'А. Буздалин', isActive: portfolioTab1, handler: handleShowPortfolioItems1 },
        { id: 2, title: 'Е. Дудкина', isActive: portfolioTab2, handler: handleShowPortfolioItems2 },
        { id: 3, title: 'Е. Малинина', isActive: portfolioTab3, handler: handleShowPortfolioItems3 },
        { id: 4, title: 'Все публикации', isActive: portfolioTab4, handler: handleShowPortfolioItems4 },
    ];

    return (
        <section className={styles.portfolio} id="portfolio">
            <div className="container">
                <MainTitle text='публикации' />
            </div>
                ...
                {!isMobile && <div className={styles.portfolio__wrapper}>
                    <button className={styles.portfolio__more} onClick={toggleHiddenPortfolioItems}>
                        <span className={styles.portfolio__more__text}>
                            {hiddenPortfolioItems ? 'Свернуть': 'Показать еще публикации'}
                        </span>
